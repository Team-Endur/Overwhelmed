...
public class OverwhelmedBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        addToTags(OverwhelmedBlocks.DESERT_SNAIL_SHELL_BRICKS, BlockTags.PICKAXE_MINEABLE);
        addToTags(OverwhelmedBlocks.DESERT_SNAIL_SHELL_BRICK_STAIRS, BlockTags.PICKAXE_MINEABLE);
        addToTags(OverwhelmedBlocks.DESERT_SNAIL_SHELL_BRICK_SLAB, BlockTags.PICKAXE_MINEABLE);
        addToTags(OverwhelmedBlocks.DESERT_SNAIL_SHELL_BRICK_WALL, BlockTags.PICKAXE_MINEABLE, BlockTags.WALLS);
        addToTags(OverwhelmedBlocks.CHISELED_DESERT_SNAIL_SHELL_BRICKS, BlockTags.PICKAXE_MINEABLE);
        ...
        addToTags(OverwhelmedBlocks.SNOW_SNAIL_SHELL_BRICKS, BlockTags.PICKAXE_MINEABLE);
        addToTags(OverwhelmedBlocks.SNOW_SNAIL_SHELL_BRICK_STAIRS, BlockTags.PICKAXE_MINEABLE);
        addToTags(OverwhelmedBlocks.SNOW_SNAIL_SHELL_BRICK_SLAB, BlockTags.PICKAXE_MINEABLE);
        addToTags(OverwhelmedBlocks.SNOW_SNAIL_SHELL_BRICK_WALL, BlockTags.PICKAXE_MINEABLE, BlockTags.WALLS);
        addToTags(OverwhelmedBlocks.CHISELED_SNOW_SNAIL_SHELL_BRICKS, BlockTags.PICKAXE_MINEABLE);
