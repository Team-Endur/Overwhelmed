    ...
    public static final ItemGroup OVERWHELMED = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("category.overwhelmed"))
                    .icon(() -> new ItemStack(OverwhelmedItems.GARDEN_SNAIL_SHELL)).entries((displayContext, entries) -> {
                        ...
                        entries.add(OverwhelmedBlocks.DESERT_SNAIL_SHELL_BRICK_WALL);
                        entries.add(OverwhelmedBlocks.CHISELED_DESERT_SNAIL_SHELL_BRICKS);
                        ...
                        entries.add(OverwhelmedBlocks.SNOW_SNAIL_SHELL_BRICKS);
                        entries.add(OverwhelmedBlocks.SNOW_SNAIL_SHELL_BRICK_STAIRS);
                        entries.add(OverwhelmedBlocks.SNOW_SNAIL_SHELL_BRICK_SLAB);
                        entries.add(OverwhelmedBlocks.SNOW_SNAIL_SHELL_BRICK_WALL);
                        entries.add(OverwhelmedBlocks.CHISELED_SNOW_SNAIL_SHELL_BRICKS);
                        ...
                        entries.add(OverwhelmedBlocks.PAPER_NEST);
...
//                        entries.add(OverwhelmedItems.BLOWGUN);
                        ...
                        entries.add(OverwhelmedItems.DESERT_SNAIL_SHELL);
                        entries.add(OverwhelmedItems.GARDEN_SNAIL_SHELL);
                        entries.add(OverwhelmedItems.SNOW_SNAIL_SHELL);
