...
public class OverwhelmedFoodComponents {
    ...
    public static final FoodComponent COOKED_SNAIL =
            new FoodComponent.Builder().nutrition(4).saturationModifier(0.9F).build();
    ...
    public static final FoodComponent VANILLA_ICE_CREAM =
            new FoodComponent.Builder().nutrition(6).saturationModifier(0.4F).build();
    ...
    public static final FoodComponent GUMBALL =
            new FoodComponent.Builder().nutrition(1).saturationModifier(11.1F).build();
